...
createGroup() {
    read -p "Ingresa el nombre del grupo: " n
...
deleteGroup() {
    ...
    read -p "Estas seguro de que deseas eliminar el grupo $n ? (s/n)" option
...
addUser() {
    read -p "Ingrese el nombre del usuario: " u
    read -p "Ingrese el nombre del grupo: " g
